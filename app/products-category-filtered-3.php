            ...
            <div class="ctg__menu">
              ...
              <div class="ctg__links">
                ...
                <div class="ctg__dropdown">
                  <div class="ctg__dropdown--title"><b>Exterior</b><i></i></div>
                ...
                <ul class="ctg__links--list">
                  <li>
                    <a href="#">All Exterior</a>

                    <ul class="ctg__links--list">
                      <li><a href="#">Area Lighting </a></li>
                      <li><a class="active" href="#">Bollard</a></li>
                      <li><a href="#">Canopy & Garage</a></li>
                      <li><a href="#">Exterior Controls</a></li>
                      <li><a href="#">Flood & Spot Lights</a></li>
                      <li><a href="#">Security Lighting</a></li>
                  ...
                  <div class="container">
                    <div class="row">
                      <div class="col-xxl-8 offset-xxl-1 text-left">
                        <div class="h6 grey-300 m-0"><b>Exterior</b> /</div>
                        <h1 class="h2 title white text-upper">Area Lighting </h1>
                ...
                <div class="col-xxl-10">
                  ...
                  <div class="row prd__row">
                    ...
                    <div class="col-xxl-auto col-md-3 col-sm-4 col-6">
                      <a class="prd__item type2" href="product-detail.php">
                        <div class="prd__item--img">
                          <img src="img/prd-img-2.png" alt="" loading="lazy">
                        </div>
                        <div class="prd__item--name">ARPT40</div>
                        <div class="prd__item--descr">ARPT Series</div>
                        <div class="prd__item--view"><b>View</b></div>
                      </a>
                    </div>
                    <div class="col-xxl-auto col-md-3 col-sm-4 col-6">
                      <a class="prd__item type2" href="product-detail.php">
                        ...
                        <div class="prd__item--name">ARPT80</div>
                        <div class="prd__item--descr">ARPT Series</div>
                        <div class="prd__item--view"><b>View</b></div>
                      </a>
                    </div>
