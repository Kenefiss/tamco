...
<head>
  ...
  <title>Tamlite || Interior Lay-ins</title>
</head>
                ...
                <ul class="ctg__links--list">
                  <li>
                    ...
                    <ul class="ctg__links--list">
                      ...
                      <li><a class="active" href="#">Lay-ins</a></li>
        ...
        <div class="category-section-right" style="background-color: var(--clr-grey-100);">
          ...
          <div class="section">
            <div class="banner-entry small prd__banner">
              <div class="banner-entry-bg" style="background-image: url('./img/prd-banner-img-5.jpg');"></div>
                  ...
                  <div class="container">
                    <div class="row">
                      <div class="col-xxl-8 offset-xxl-1 text-left">
                        ...
                        <h1 class="h2 title white text-upper">LED Lay-Ins</h1>
                ...
                <div class="col-xxl-10">
                  ...
                  <div class="prd__title--wrap">
                    <div class="prd__title--count">
                      Displaying <b>2</b> of <b>2</b> products
                    </div>
                  </div>
                        ...
                        <div class="swiper-slide">
                          <div class="prd__item type3">
                            <a class="prd__item--img" href="product-detail.php">
                              <img src="img/prd-img-68.png" alt="" loading="lazy">
                            </a>
                            <div class="prd__item--name">TLP-SKP</div>
                            <div class="prd__item--descr">BLP Series</div>
                          </div>
                        </div>
                        <div class="swiper-slide">
