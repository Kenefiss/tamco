    ...
    <div class="popup-align type-6 text-left">
      ...
      <div class="project-list-wrapp">
        ...
        <ul class="project-list">
          <li class="open-popup" data-rel="create-project-success">
            <div class="icon">
  ...
  <div class="popup-container size-4 type-2">
    <div class="popup-align type-3 text-left">
      ...
      <form class="form-wrapp">
        ...
        <div class="form-block text-center open-popup" data-rel="create-project-success">
          <button class="btn btn-2 btn-fourth btn-submit">
            <b>Create Project</b>
          </button>
        </div>
        ...
        <div class="form-block">
          <div class="checkbox-entry-wrap">
            <label class="checkbox-entry">
              ...
              <span>Empty Product Basket</span>
            </label>
          </div>
        </div>

        <div class="form-block text-center">
          <a class="btn btn-2 btn-fourth" href="project-detail.php">
            <b>View Project</b>
          </a>
        </div>
      </form>
