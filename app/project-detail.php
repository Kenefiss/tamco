...
<body style="background-color: var(--clr-grey-100);">
    ...
    <div id="content-block">
        ...
        <main>
            ...
            <div class="section table-project-sec">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xxl-8 col-md-10 col-12">
                            <div class="btn-wrapper">
                            ...
                            <table class="table-project">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="prd__item--name btn-link btn-link-thirdy">
                                                HBM23040K-UN4-ACR-BK
                                            </a>
                                        </td>
                                        <td>
                                            <input type="text" name="type" value="Aliqueteget" readonly>
                                        </td>
                                        <td>
                                            <div>1</div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="type" value="A1" readonly>
                                        </td>
                                        <td>
                                            <div>1</div>
                                        </td>
