    ...
    <main>
      ...
      <div class="section">
        <div class="banner-entry small prd__banner">
          <div class="banner-entry-bg" style="background-image: url('./img/prd-banner-img.jpg');"></div>
        ...
        <div class="navigation-panel">
          <ul>
            <li class="scroll-to type2" data-scroll-to="exterior">Exterior</li>
            <li class="scroll-to type2" data-scroll-to="harsh">Harsh Hazardous</li>
            <li class="scroll-to type2" data-scroll-to="interior">Interior</li>
            <li class="scroll-to type2" data-scroll-to="voltage">Low Voltage Lighting Systems</li>
            <li class="scroll-to type2" data-scroll-to="specialty">Specialty</li>
          </ul>
        </div>

        <div class="spacer-md" style="background-color: var(--clr-grey-100);"></div>
      </div>

      <!-- Products section -->
      <div class="section" style="background-color: var(--clr-grey-100);" data-scroll-block="exterior">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xxl-8 col-xl-9 col-lg-10">
              <!-- Title -->
              <div class="h2 title prd__page-title">Exterior</div>
      ...
      <!--  Products section -->
      <div class="section" style="background-color: var(--clr-grey-100);" data-scroll-block="harsh">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xxl-8 col-xl-9 col-lg-10">
              <!-- Title -->
              <div class="h2 title prd__page-title">Harsh Hazardous</div>
      ...
      <!--  Products section -->
      <div class="section" style="background-color: var(--clr-grey-100);" data-scroll-block="interior">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xxl-8 col-xl-9 col-lg-10">
              <!-- Title -->
              <div class="h2 title prd__page-title">Interior</div>
      ...
      <!--  Products section -->
      <div class="section" style="background-color: var(--clr-grey-100);" data-scroll-block="voltage">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xxl-8 col-xl-9 col-lg-10">
              <!-- Title -->
              <div class="h2 title prd__page-title">Low Voltage Lighting Systems</div>
      ...
      <!--  Products section -->
      <div class="section" style="background-color: var(--clr-grey-100);" data-scroll-block="specialty">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xxl-8 col-xl-9 col-lg-10">
              <!-- Title -->
              <div class="h2 title prd__page-title">Specialty</div>
